import { useState, useCallback, useEffect } from 'hono/jsx/dom'
...
export default function ChatLayout({ apiKey, userName, colorSchema, onNameChange, onSchemaChange }: ChatLayoutProps) {
  ...
  // URL routing
  const { pushRoom, replaceUrl } = useUrlRouting(rooms, useCallback((roomId: string | null) => {
    if (roomId) {
