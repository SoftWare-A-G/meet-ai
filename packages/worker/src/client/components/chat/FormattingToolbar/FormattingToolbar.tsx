...
export default function FormattingToolbar({ textareaRef, onSend }: FormattingToolbarProps) {
  ...
  return (
    <div class="chat-input-toolbar">
      <button class="fmt-btn" title="Bold" onMouseDown={preventBlur} onTouchStart={preventBlur} onClick={() => handleFormat('bold')}>
      ...
      <button class="fmt-btn" title="Italic" onMouseDown={preventBlur} onTouchStart={preventBlur} onClick={() => handleFormat('italic')}>
      ...
      <button class="fmt-btn" title="Code" onMouseDown={preventBlur} onTouchStart={preventBlur} onClick={() => handleFormat('code')}>
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6" /><polyline points="8 6 2 12 8 18" /></svg>
      </button>
      <button class="fmt-btn" title="Link" onMouseDown={preventBlur} onTouchStart={preventBlur} onClick={() => handleFormat('link')}>
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" /><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" /></svg>
      </button>
      <div class="toolbar-spacer" />
      <button class="send-btn" title="Send" onMouseDown={preventBlur} onTouchStart={preventBlur} onClick={onSend}>
