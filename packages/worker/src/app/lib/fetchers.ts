...
export type TasksResponse = InferResponseType<
  ApiClient['api']['rooms'][':id']['tasks']['$get'],
  200
>
export type TaskItem = TasksResponse['tasks'][number]
export type CreateTaskResponse = InferResponseType<
  ApiClient['api']['rooms'][':id']['tasks']['create']['$post'],
  201
>
export type UpdateTaskResponse = InferResponseType<
  ApiClient['api']['rooms'][':id']['tasks'][':taskId']['$patch'],
  200
>
...
export type CreateTaskInput = InferRequestType<
  ApiClient['api']['rooms'][':id']['tasks']['create']['$post']
>
export type UpdateTaskInput = InferRequestType<
  ApiClient['api']['rooms'][':id']['tasks'][':taskId']['$patch']
>
export type DeleteTaskInput = InferRequestType<
...
export type AttachmentCountsResponse = InferResponseType<
  ApiClient['api']['rooms'][':id']['attachment-counts']['$get'],
  200
>
export type TeamInfoResponse = InferResponseType<
  ApiClient['api']['rooms'][':id']['team-info']['$get'],
  200
>
...
// Send message
export type SendMessageInput = InferRequestType<
  ApiClient['api']['rooms'][':id']['messages']['$post']
>
...
export type DecidePlanReviewInput = InferRequestType<
  ApiClient['api']['rooms'][':id']['plan-reviews'][':reviewId']['decide']['$post']
>
export type ExpirePlanReviewInput = InferRequestType<
  ApiClient['api']['rooms'][':id']['plan-reviews'][':reviewId']['expire']['$post']
>
export type AnswerQuestionInput = InferRequestType<
  ApiClient['api']['rooms'][':id']['question-reviews'][':reviewId']['answer']['$post']
>
export type ExpireQuestionInput = InferRequestType<
  ApiClient['api']['rooms'][':id']['question-reviews'][':reviewId']['expire']['$post']
>
export type DecidePermissionInput = InferRequestType<
  ApiClient['api']['rooms'][':id']['permission-reviews'][':reviewId']['decide']['$post']
>
export type ExpirePermissionInput = InferRequestType<
  ApiClient['api']['rooms'][':id']['permission-reviews'][':reviewId']['expire']['$post']
>
...
// Auth fetchers
export type ClaimTokenResponse = InferResponseType<
  ApiClient['api']['auth']['claim'][':token']['$get'],
  200
>
