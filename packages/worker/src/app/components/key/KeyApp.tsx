  ...
  const renderState = () => {
    switch (state.view) {
      ...
      case 'loading':
        return (
          <>
            <h1 className="headline font-mono font-extrabold tracking-tight leading-tight text-center">
              Your key to the conversation.
            </h1>
            <div className="flex flex-col items-center gap-4">
              <button
                className="group inline-flex items-center justify-center gap-2 py-3.5 px-8 border-0 rounded-full bg-blue-600 text-white cursor-wait text-base font-semibold no-underline transition-colors duration-150 shadow-[0_0_60px_rgba(37,99,235,0.08)] opacity-60 max-[520px]:w-full"
                disabled
              >
