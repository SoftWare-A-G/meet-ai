    ...
    <>
      ...
      <div className="flex flex-col items-center gap-4 stagger-in">
        <div className="flex flex-col gap-3 w-full max-w-md">
          <div className="flex gap-2 items-center relative max-[520px]:flex-col">
            <input
              ref={inputRef}
              type="text"
              ...
              disabled={loading}
              className="flex-1 py-3 px-3.5 border border-edge-light border-l-[3px] border-l-blue-600 rounded-lg bg-edge text-text-primary font-mono text-base outline-none transition-[border-color] duration-150 focus:border-edge-hover focus:border-l-blue-600 max-[520px]:w-full"
            />
            <button
