  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        {!showConfirm && (
          <>
            <div className="stagger-in flex flex-wrap justify-center gap-3">
              ...
              <button
                type="button"
                className="inline-flex cursor-pointer items-center justify-center rounded-full border border-edge-light bg-edge px-6 py-3 text-sm font-medium text-text-primary no-underline transition-colors duration-150 hover:border-edge-hover hover:bg-edge-dim"
        ...
        {showConfirm && (
          <div className="fade-in flex flex-col items-center gap-3 rounded-xl border border-edge-light bg-edge p-5">
            ...
            <div className="flex gap-3">
              <button
                type="button"
                className="cursor-pointer rounded-full border border-edge-light bg-transparent px-5 py-2 text-[13px] text-text-secondary transition-colors duration-150 hover:bg-edge-dim hover:text-text-primary"
