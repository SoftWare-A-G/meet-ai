  ...
  return (
    <div className="px-4 py-2.5 border-t border-sidebar-border flex items-center gap-2 text-xs h-[52px]">
      ...
      <div className="flex items-center gap-1">
        ...
        <button className="bg-transparent border-none text-sidebar-text cursor-pointer text-[11px] p-1 rounded opacity-60 flex items-center justify-center hover:opacity-100 hover:bg-hover-item" title="API Key settings" onClick={() => { location.href = '/key' }}>
