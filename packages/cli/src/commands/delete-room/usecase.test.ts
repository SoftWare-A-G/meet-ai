...
function makeMockClient(overrides: Partial<MeetAiClient> = {}): MeetAiClient {
  return {
    ...
    createRoom: mock(() => Promise.resolve({ id: "r1", name: "test", projectId: null, createdAt: "2026-01-01 00:00:00" })),
    sendMessage: mock(() =>
    ...
    updateRoom: mock(() => Promise.resolve({ id: "r1", name: "test", projectId: null, createdAt: "2026-01-01 00:00:00" })),
