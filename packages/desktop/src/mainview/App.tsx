  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-indigo-500 to-purple-600 text-gray-900">
      <div className="container mx-auto max-w-3xl px-4 py-10">
        <h1 className="mb-2 text-center text-5xl font-bold text-white drop-shadow-lg">Meet AI</h1>
        ...
        <div className="mb-8 rounded-xl bg-white p-8 shadow-xl">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="rounded-lg bg-indigo-600 px-6 py-3 font-medium text-white tabular-nums shadow-md transition-colors hover:bg-indigo-700 hover:shadow-lg">
              Count: {count}
            </button>
            <button
              type="button"
