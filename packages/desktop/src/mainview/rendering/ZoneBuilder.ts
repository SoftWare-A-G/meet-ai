...
function addZoneStructure(
  ...
  if (type === 'library') {
    ...
    const baseGeo = new THREE.BoxGeometry(1, 0.5, 0.6)
    ...
    const screenGeo = new THREE.BoxGeometry(1, 0.7, 0.05)
